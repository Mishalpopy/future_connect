            ...
            <nav>
              <ul>
                <li className="mil-has-children">
                  ...
                  <ul>
                    <li>
                      <Link href="/">About Future Connects</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/">What Set Us Apart</Link>
                    </li>
                    <li>
                      <Link href="/">Your Business Advantages</Link>
                    </li>
                ...
                <li className="mil-has-children">
                  ...
                  <ul>
                    <li>
                      <Link href="/">Communication, Audiovisual & Transmission</Link>
                    </li>
                    <li>
                      <Link href="/">Networking, IT & Cyber Security</Link>
                    </li>
                    <li>
                      <Link href="/">Security, Safety & Automation</Link>
                    </li>
                    <li>
                      <Link href="/">Digital, Development & Application</Link>
                    </li>
                  </ul>
                </li>
                <li>
